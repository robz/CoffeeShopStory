    ...
    createStoryTeller({
        ...
        characters: {
            David: {
                ...
                known: false,
                stories: [
                    "David holds the door open for @Angela, and then steps into the coffee shop. <br/><br/>He immediately takes note of @Julia reading a book in a comfortable chair near the far wall.",
            ...
            Angela: {
                ...
                stories: [
                    ...
                    "Angela hears @Monica call her name from inside the cafe. <em>That was fast!</em> Just before rising from her table she sees a particularly interesting I-Saw-You post, and pauses to read it:<br><br/><div id=\"sara-note\">I was able to catch the 6 because you held the door. You looked beat, it appeared you were on your way home from work. I was standing against the door, you facing me wearing a nice brown coat. We both reached for the pole and our hands touched. We rode one stop to 42nd (my stop), as I was leaving I sneezed and even though you didn&#8217;t know me you blessed me and it was wonderful. I hope to find you. &#8212;%Sara</div>",
            ...
            Monica: {
                ...
                stories: [
                    ...
                    "The next person to order is @David, fumbling with his phone.<br/><br/>&#8220;What can I get you?&#8221;<br/><br/>&#8220;Uh&#8212;I think I&#8217;ll just have a coffee, thanks&#8221; he responds, and hands her a credit card. &#8220;And you can keep a tab open.&#8221;<br/><br/>As Monica takes the his card, she looks at his first name: %David. She writes it onto a piece of paper to keep track of his tab, then turns around to fill a cup of coffee for him."
                ]
            },
